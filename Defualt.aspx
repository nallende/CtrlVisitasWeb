         ...
         <div class="-center jumbotron">
                ...
                <div class=" -center -row mt-5">
                    ...
                    <br />
                            ...
                            <asp:RequiredFieldValidator CssClass="text-danger" ControlToValidate="TextBoxRut" ID="RequiredFieldValidator1" runat="server" ErrorMessage="Debe Ingresar RUT"></asp:RequiredFieldValidator>

                            <asp:CustomValidator ID="rutCustomValidator"  CssClass="text-danger" runat="server" 
                                ControlToValidate="TextBoxRut" 
                                OnServerValidate="RutCustomValidator_ServerValidate"
                                ErrorMessage="Debe Ingresar RUT Valido">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div>
                                   ...
                                   <%-- <asp:Button ID="btnListarVisita" CssClass="btn btn-primary -spacing btn-warning " OnClick="btnListarVisita_Click" runat="server" Text="Listar Info  Visita" />--%>
                                </div>
                            </div>
